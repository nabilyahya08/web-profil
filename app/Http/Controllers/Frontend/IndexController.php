...
class IndexController extends Controller
{
    ...
    public function strukturorganisasi()
    {
        ...
        $visimisi = Visimisi::first();
        return view('frontend.content.strukturorganisasi', compact('visimisi', 'jurusanM', 'kegiatanM', 'pengajar', 'footer'));
    }
    ...
    public function kalenderakademik()
    {
        ...
        $visimisi = Visimisi::first();
        return view('frontend.content.kalenderakademik', compact('visimisi', 'jurusanM', 'kegiatanM', 'pengajar', 'footer'));
    }
}
