                        ...
                        <ul>
                            ...
                            <li><a href="#">Tentang Kami</a>
                                <ul>
                                    ...
                                    <li><a href="{{ route('strukturorganisasi.sekolah') }}">Struktur Organisasi</a></li>
                                </ul>
                            </li>

                            <li><a href="#">Pendidikan</a>
                                <ul>
                                    <li><a href="{{ route('kalenderakademik.sekolah') }}">Kalender Akademik</a>
                                    </li>
                                    ...
                                    <li class="has-child-menu"><a href="#">Prestasi Sekolah</a>
                                        <ul class="thired-level">
                                            @foreach ($kegiatanM as $kegiatans)
                                                <li><a
                                                        href=" {{ url('kegiatan', $kegiatans->slug) }} ">{{ $kegiatans->nama }}</a>
                                    ...
                                    <li class="has-child-menu"><a href="#">Prestasi Siswa</a>
                                        <ul class="thired-level">
                                            @foreach ($kegiatanM as $kegiatans)
                                                <li><a
                                                        href=" {{ url('kegiatan', $kegiatans->slug) }} ">{{ $kegiatans->nama }}</a>
                                    ...
                                    <li class="has-child-menu"><a href="#">Prestasi Guru</a>
                                        <ul class="thired-level">
                                            @foreach ($kegiatanM as $kegiatans)
                                                <li><a
                                                        href=" {{ url('kegiatan', $kegiatans->slug) }} ">{{ $kegiatans->nama }}</a>
