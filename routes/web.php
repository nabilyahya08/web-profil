...
Route::get('struktur-organisasi', [App\Http\Controllers\Frontend\IndexController::class, 'strukturorganisasi'])->name('strukturorganisasi.sekolah');
Route::get('kalender-akademik', [App\Http\Controllers\Frontend\IndexController::class, 'kalenderakademik'])->name('kalenderakademik.sekolah');
